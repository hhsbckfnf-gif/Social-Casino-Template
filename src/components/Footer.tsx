  ...
  <footer className="border-t border-border/50 bg-background">
    <div className="container mx-auto px-4 py-12">
      <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-4">
        <div>
          <span className="text-xl font-display font-bold text-gradient"><span className="text-xl font-display font-bold text-gradient">🦊 Trend Lorexa</span></span>
      ...
      <div className="mt-10 border-t border-border/50 pt-6 text-center">
        <p className="text-xs text-muted-foreground">
          © {new Date().getFullYear()} © {new Date().getFullYear()} Trend Lorexa. This website is for entertainment purposes only. No real money gambling. No prizes or items of real-world value. 18+ only. Play responsibly. is for entertainment purposes only. No real money gambling. No prizes or items of real-world value. 18+ only. Play responsibly.
        </p>
      </div>
    </div>
  </footer>
